...
public class CueSheetKmlParser implements CueSheetParser
{

    private final InputStream inputStream;

    CueSheetKmlParser(InputStream inputStream)
    {
    ...
    private static class KmlParser extends DefaultHandler
    {
        ...
        private enum Element
        {
            ...
            PLACEMARK
            {
                ...
                @Override
                protected void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException
                {
                    title = null;
                    description = null;
                    latLon = null;

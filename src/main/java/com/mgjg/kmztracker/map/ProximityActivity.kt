...
import com.mgjg.kmztracker.map.NotificationView

class ProximityActivity : Activity() {

  internal lateinit var notificationTitle: String
  internal lateinit var notificationContent: String
  internal lateinit var tickerMessage: String
